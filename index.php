...
<body class="bg-light">
<div class="container">
    <img class="py-3 d-block mx-auto mb-1" src="img/matchlogo.png" alt="" width="300">
    <p class="text-center">Move one match and fix an equation</p>
    <div id="al" class="alert" style="display: none;" role="alert">
    </div>
